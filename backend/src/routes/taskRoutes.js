...
router.put('/update/:taskId', upload.single('cover'), uploadToCloud, updateTask);
router.delete('/delete/:taskId', deleteTask);
router.put('/move/:taskId', moveTask);
router.post('/comment/:taskId', upload.single('attachment'), uploadToCloud, validateComment, addComment);
